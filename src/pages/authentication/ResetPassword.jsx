    ...
    <div className="h-screen md:flex overflow-hidden">
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex flex-col items-center gap-4 p-8 rounded-lg border-2 border-sky-100 bg-transparent">
            ...
            <span className="text-3xl font-bold text-esblack dark:text-eswhite">
              LMS
            </span>
      ...
      <div className="flex flex-1 h-screen items-center justify-center p-8 bg-white dark:bg-gray-900">
        <form
          ...
          className="w-full max-w-md rounded-lg p-6 shadow-md bg-sky-50 dark:bg-gray-700 overflow-hidden flex flex-col space-y-4"
        >
          <h2 className="text-3xl font-bold text-esblack text-center">
            Reset Your Password
          </h2>
